...
type TicketHandler struct {
	repostitory models.TicketRepository
}
...
func (h *TicketHandler) GetMany(ctx *fiber.Ctx) error {
	...
	tickets, err := h.repostitory.GetMany(context, userId)
...
func (h *TicketHandler) GetOne(ctx *fiber.Ctx) error {
	...
	ticket, err := h.repostitory.GetOne(context, userId, uint(ticketId))
...
func (h *TicketHandler) CreateOne(ctx *fiber.Ctx) error {
	...
	ticket, err := h.repostitory.CreateOne(context, userId, ticket)
...
func (h *TicketHandler) ValidateOne(ctx *fiber.Ctx) error {
	...
	ticket, err := h.repostitory.UpdateOne(context, validateBody.OwnerId, validateBody.TicketId, validateData)
